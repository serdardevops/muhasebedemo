...
const seedDemoData = async () => {
    try {
        ...
        const demoCompany = await database_1.default.company.create({
            data: {
        ...
        const demoUser = await database_1.default.user.create({
            data: {
        ...
        const customers = await Promise.all([
            database_1.default.customer.create({
                data: {
        ...
        const suppliers = await Promise.all([
            database_1.default.supplier.create({
                data: {
        ...
        const products = await Promise.all([
            database_1.default.product.create({
                data: {
        ...
        const invoice1 = await database_1.default.invoice.create({
            data: {
        ...
        await database_1.default.invoiceItem.create({
            data: {
                quantity: 1,
                price: 5000.0,
                total: 5000.0,
        ...
        const invoice2 = await database_1.default.invoice.create({
            data: {
        ...
        for (const entry of cashBookEntries) {
            currentBalance = entry.type === 'CASH_IN'
                ...
                : currentBalance - entry.amount;
            await database_1.default.cashBook.create({
                data: {
                    ...entry,
