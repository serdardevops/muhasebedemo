...
# Muhasebe Demo - Otomatik Kurulum Scripti
...
echo "║                                                              ║"
echo "║  Bu script projenizi otomatik olarak kuracak ve             ║"
echo "║  çalıştıracaktır. Lütfen bekleyiniz...                      ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo -e "${NC}"
...
install_dependencies() {
    ...
    cd backend
    npm install > /dev/null 2>&1
    npm install --save-dev tsconfig-paths > /dev/null 2>&1
    cd ..
    ...
    npm install @tanstack/react-query-devtools > /dev/null 2>&1
    cd ..
...
# Hata yakalama
trap 'print_error "Kurulum sırasında hata oluştu! Lütfen hata mesajlarını kontrol edin."' ERR
